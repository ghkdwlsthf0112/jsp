...
<body>
	...
	<ul>
		...
		<li>프로젝트 이름에 해당하는 부분을 ContextPath라고 부른다</li>
	...
	<!-- 상대경로를 쓰는 경우 내가 이곳에 접속하는데 사용했던 URL의 상대경로로 요청을 보낸다 -->
	<a href="./test1.html">test.html</a>
	
	<img src="http://192.168.0.66:9000/chap05/path/pen2.jpg" >
