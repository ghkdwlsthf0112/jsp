...
<body>
 	...
 	<ul>
 		...
 		<li>input 태그의 name 속성이 데이터의 kek역할을 하여 value와 함께 전송된다</li>
 	...
 	<ul>
 		<li>GET방식 요청은 데이터가 ?key=value&key2=value2...형태로
 			URL의 맨 뒤에 붙어서 전송된다</li>
 		<li>비밀번호 같은 중요한 정보들은 GET</li>
 	</ul>
 	...
 	<ul>
 		<li>POST 방식으로 데이터를 URL에 노출 되지 않은 채로 실어 보낼 수 있다</li>
